	...
	public Result() {
		...
		contentPane.addMouseMotionListener(new MouseMotionAdapter() {
			...
			public void mouseDragged(MouseEvent e) {
		        ...
		        Result.this.setLocation(x - xx, y - xy);  
			}
		});
		...
		JLabel lblNewLabel_1_1 = new JLabel("1SRI");
		...
		JLabel lblArchitecture = new JLabel("Architecture Des Ordinateurs :");
		lblArchitecture.setFont(new Font("Tw Cen MT Condensed Extra Bold", Font.PLAIN, 15));
		lblArchitecture.setBounds(10, 79, 269, 18);
		panel_1.add(lblArchitecture);
		
		JLabel lblEej = new JLabel("Environement Economique Et Juridrique : ");
		lblEej.setFont(new Font("Tw Cen MT Condensed Extra Bold", Font.PLAIN, 15));
		lblEej.setBounds(10, 108, 256, 18);
		panel_1.add(lblEej);
		...
		panel_1.add(linux);
		 ...
		 arch = new JLabel("");
		arch.setFont(new Font("Tw Cen MT Condensed", Font.BOLD, 15));
		arch.setBounds(276, 81, 70, 15);
		panel_1.add(arch);
		
		 eej = new JLabel("");
		eej.setFont(new Font("Tw Cen MT Condensed", Font.BOLD, 15));
		eej.setBounds(276, 110, 70, 15);
		panel_1.add(eej);
		
		JLabel lblMath = new JLabel("Mathematiques : ");
		lblMath.setFont(new Font("Tw Cen MT Condensed Extra Bold", Font.PLAIN, 15));
		lblMath.setBounds(10, 137, 247, 18);
		panel_1.add(lblMath);
		
		 math = new JLabel("");
		math.setFont(new Font("Tw Cen MT Condensed", Font.BOLD, 15));
		math.setBounds(276, 139, 70, 15);
		panel_1.add(math);
