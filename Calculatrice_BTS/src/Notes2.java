	...
	public Notes2() {
		...
		contentPane.addMouseMotionListener(new MouseMotionAdapter() {
			...
			public void mouseDragged(MouseEvent e) {
		        ...
		        Notes2.this.setLocation(x - xx, y - xy);  
			}
		});
			 	...
			 	public void mousePressed(MouseEvent e) {
						...
						try {
							...
							conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/pfe","root","");
							 ps = conn.prepareStatement("insert into 2sri(Nom,ModulCom,ModulPro,ModulTechni,Total) values(?,?,?,?,?);");
						...
						System.out.println(Nom.getText());
							...
							Pro = ((Windows*30)+(Reseau*30)) / 60;
						
							 Dev  = (Devn1+Devn2)/2  ;
							 Linux = (Linuxn1+Linuxn2)/2;
							
							 Math = (Mathn1+Mathn2)/2;
							Techni = ((Dev*15)+(Linux*20)+(Math*15))/ 50;
							
							Total = ((Com*40)+(Pro*60)+(Techni*50))/150;
							...
							//File file = new File("C:\\Resultat.txt");
							FileWriter writer = new FileWriter("C:\\App\\Resultat.txt");
			        	    writer.write("                                     Resultat Finale         "+"\n\n");
			   		     	writer.write("Anne et Filiére :  2SRI "+ "\n");
		...
		calculer.setBounds(564, 435, 301, 58);
		...
		JLabel lblsri = new JLabel("2Ann\u00E9e Syst\u00E9mes Et Reseaux Informatiques");
		...
		lblNewLabel_4_1_2_2.setBounds(204, 141, 626, 43);
		...
		panel_2_2.setBounds(491, 221, 480, 156);
		...
		lblNewLabel_4_1_1_2_1.setBounds(10, 55, 253, 31);
		...
		lblNewLabel_4_1_1_3_1_1.setBounds(10, 100, 253, 31);
		...
		lblNewLabel_1.setBounds(491, 388, 505, 34);
